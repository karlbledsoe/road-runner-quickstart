...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -13132.652327726735; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -par0YTicks; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 11320.782395090351; // x position of the perpendicular encoder (in tick units)
    }
